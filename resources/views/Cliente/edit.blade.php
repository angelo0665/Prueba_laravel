	...
	<section class="content">
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="alert alert-danger">
				<strong>Error!</strong> Revise los campos obligatorios requeridos.<br><br>
				<ul>
					...
					<div class="table-container">
						<form method="POST" action="{{ route('cliente.update',$cliente->id) }}"  role="form">
							...
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="email" name="email" id="email" class="form-control input-sm" value="{{$cliente->email}}">
									</div>
								</div>
							</div>

							<div class="form-group">
								<textarea name="direccion" class="form-control input-sm"  placeholder="Dirección">{{$cliente->direccion}}</textarea>
							</div>
							<div class="form-group">
